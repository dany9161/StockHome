...
import com.example.dany.stockhome.Activities.EditarReceitasActivity;
import com.example.dany.stockhome.Activities.FazerReceitaActivity;
 ...
 */
public class ReceitasRecyclerAdapter extends RecyclerView.Adapter<ReceitasRecyclerAdapter.RecyclerViewHolder> {

    ArrayList<Receita> arrayList = new ArrayList<>();

    public ReceitasRecyclerAdapter(ArrayList<Receita> arrayList) {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), FazerReceitaActivity.class);
