 ...
 */
public class RecyclerAdapter_ingredientes_adiciona extends RecyclerView.Adapter<RecyclerAdapter_ingredientes_adiciona.RecyclerViewHolder> {
    ...
    public RecyclerAdapter_ingredientes_adiciona(ArrayList<Ingrediente> arrayList){this.arrayList = arrayList;}
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), edita_ingrdientes_adiciona.class);
