...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String RECEITAS_COLUMN_ID = "_idReceitas";
    public static final String RECEITAS_COLUMN_NAME = "Nome";
    public static final String RECEITAS_COLUMN_PREPARACAO = "Preparacao";
    //TABELA INGREDIENTES
    public static final String TABLE_INGREDIENTES = "ingredientes";
    public static final String COLUMN_ID_RECEITAS = "_idReceitas";
    public static final String COLUMN_ID_PRODUTOS = "_idProduto";
    public static final String INGREDIENTES_COLUMN_QUANTIDADE = "Quantidade";
    public static final String COLIMN_ID_UNIDADE = "_id";
    //TABELA PRODUTOS
    public static final String TABLE_PRODUTOS = "produtos";
    public static final String PRODUTOS_COLUMN_ID = "_idProdutos";
    public static final String PRODUTOS_COLUMN_NAME = "Nome";
    public static final String PRODUTOS_COLUMN_QUANTIDADE = "Stock";
    public static final String PRODUTOS_COLUMN_UNIDADE = "_idUnidade";
    //TABELA UNIDADES
    public static final String TABLE_UNIDADES = "unidades";
    public static final String UNIDADES_COLUMN_ID = "_id";
    public static final String UNIDADES_COLUMN_UNIDADE = "unidade";
    //UNIDADES
    public static final String UNIDADES_LITROS = "Lt";
    public static final String UNIDADES_GRAMAS = "Gr";
    public static final String UNIDADES_PEÇAS = "Uni.";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXIST " + TABLE_RECEITAS);
        db.execSQL("DROP TABLE IF EXIST " + TABLE_INGREDIENTES);
        db.execSQL("DROP TABLE IF EXIST " + TABLE_PRODUTOS);
        onCreate(db);
    }
