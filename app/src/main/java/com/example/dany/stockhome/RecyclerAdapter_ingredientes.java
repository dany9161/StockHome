 ...
 */
public class RecyclerAdapter_ingredientes extends RecyclerView.Adapter<RecyclerAdapter_ingredientes.RecyclerViewHolder> {
   ...
   Cursor data;
    ...
    public RecyclerAdapter_ingredientes(ArrayList<Ingrediente> arrayList){this.arrayList = arrayList;}
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), edita_ingredientes.class);
