...
import com.example.dany.stockhome.Activities.EditaIngredientesActivity;
 ...
 */
public class IngredientesRecyclerAdapter extends RecyclerView.Adapter<IngredientesRecyclerAdapter.RecyclerViewHolder> {
    ...
    public IngredientesRecyclerAdapter(ArrayList<Ingrediente> arrayList) {
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), EditaIngredientesActivity.class);
