 ...
 */
public class RecyclerAdapter_Ing_Fazer extends RecyclerView.Adapter<RecyclerAdapter_Ing_Fazer.RecyclerViewHolder> {
...
public RecyclerAdapter_Ing_Fazer(ArrayList<Ingrediente> arrayList){this.arrayList = arrayList;}
